...
p. Let's go through a sample game:
...
p. The scoring for the tenth frame goes as follows:
...
p. Back to our game—Frame 10 = Strike. Score 30 (10x3). Total = 207. As for the two bonus balls, let's say our bowler leaves a 6-10 and picks it up for the spare. Score 16 for the first fill ball (8x2) and 2 for the second.

p. Final score = 225. This game is an illustration of how dramatically a player's score can skyrocket as a result of stringing together several strikes.
